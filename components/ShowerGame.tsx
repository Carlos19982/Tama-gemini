    ...
    >
      ...
      <div className="relative w-64 h-64 mt-10 pointer-events-none">
        ...
        {dirt.map((d) => (
          ...
          >
             <span className="text-3xl filter drop-shadow-md grayscale opacity-80">💩</span>
          </div>
        ))}
        ...
        {dirt.length < 5 && !isClean && (
             <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-10 left-10 text-xl animate-bounce opacity-50">🫧</div>
                <div className="absolute bottom-10 right-10 text-xl animate-bounce delay-100 opacity-50">🫧</div>
             </div>
        )}
